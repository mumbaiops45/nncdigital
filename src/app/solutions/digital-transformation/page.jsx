    ...
    <div className="bg-[#1A2343] text-white">
      ...
      <section className="relative px-6 py-14">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          className="mt-14 flex gap-5 overflow-x-auto no-scrollbar p-5 scroll-smooth">
            {servicesOffered.map((s) => {
              const Icon = s.icon;
              return (
                <motion.div key={s.title} variants={fadeUp}
                // className="group rounded-2xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-1.5 hover:border-cyan-400/40 hover:bg-white/[0.07] hover:shadow-[0_15px_40px_-12px_rgba(6,182,212,0.4)]"
