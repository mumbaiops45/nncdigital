...
const caseStudies = [
  {
    sector: "Manufacturing", region: "Canada", image: "/businessfast.webp",
  ...
  {
    sector: "Industrial Supply", region: "USA", image: "/nycsultancy.webp",
  ...
  {
    sector: "Manufacturing", region: "UK", image: "/accountancylondon.jpg",
...
const solutions = [
  { icon: Handshake, title: "Client Relationship CRM", desc: "Complete client history, contact management, and communication tracking for professional services firms." },
  { icon: BarChart3, title: "Track projects, matters, and engagements with time tracking and deliverable management" },
  { icon: Settings, title: "Client Onboarding Automation", desc: "Automated intake forms, KYC/AML checks, engagement letters, and welcome sequences." },
  { icon: Package, title: "Business Development Pipeline", desc: "Track opportunities, pursuits, and BD activities with partner-level pipeline visibility." },
  { icon: Plug, title: "Document Management & e-Signature", desc: "Secure document storage, version control, and integrated e-signature workflows." },
  { icon: Wrench, title: "Client Portal Development", desc: "Self-service portals for clients to access documents, track matters, and communicate securely." },
  { icon: CheckCircle2, title: "Time & Billing Integration", desc: "Seamless sync with practice management and accounting systems for accurate billing." },
  { icon: Building2, title: "KYC/AML Workflow Automation", desc: "Automated identity verification, risk assessment, and compliance documentation." },
  { icon: TrendingUp, title: "Partner Performance Reporting", desc: "Real-time dashboards for billable hours, realization rates, and pipeline health by partner." },
];

const integration = [
  { icon: Handshake, title: "AML/KYC Compliance", tag: "AML/KYC", desc: "Built-in KYC and AML workflow support for law firms, accountancies, and financial services in Canada, USA and UK." },
  { icon: Plug, title: "GDPR & PIPEDA", tag: "Data Protection", desc: "Client data handled to GDPR (UK/EU) and PIPEDA (Canada) standards across all modules with consent management." },
  { icon: CheckCircle2, title: "SRA & Law Society Standards", tag: "Regulatory", desc: "Document and matter management aligned with SRA (UK) and Law Society (Canada) regulatory requirements." },
];
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <motion.div style={{ y: heroY }}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <SectionLabel>Professional Services Technology</SectionLabel>
            </motion.div>
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="mt-6 text-4xl font-bold leading-tight md:text-5xl">
              Digital Systems for <span className={grad}>Professional Services Firms</span> in Canada, USA & UK
            </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }} className="relative">
            ...
            <form onSubmit={handleSubmit} className="relative rounded-3xl border border-white/10 bg-[#0a1228]/90 p-7 backdrop-blur-xl md:p-8">
              ...
              <input type="text" name="fullname" onChange={handleChange} placeholder="Full Name *" className={`${inputClass} mt-5`} />
              <div className="mt-4 grid grid-cols-[110px_1fr] gap-3">
                ...
                <input type="tel" placeholder="Phone Number *" name="phone" value={form.phone} onChange={handleChange} className={inputClass} />
              </div>
              ...
              onChange={handleChange} className={`${inputClass} mt-4`} defaultValue="">
              ...
              <textarea rows="2" name="message" value={form.message} onChange={handleChange} placeholder="Message *" className={`${inputClass} mt-4 resize-none`} />
      ...
      <section className="relative px-6 py-14">
        <div className="mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold md:text-4xl">Professional Services <span className={grad}>Success Stories</span></h2>
          </div>
      ...
      <section className="relative px-6 py-14">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold md:text-4xl">Professional Services Digital Solutions <span className={grad}>We Build</span></h2>
          </div>
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="relative mt-10 text-left">
            ...
            <form onSubmit={handleSubmit} className="relative rounded-3xl border border-white/10 bg-[#0a1228]/90 p-8 backdrop-blur-xl md:p-10">
              ...
              <input type="text" name="fullname" onChange={handleChange} value={form.fullname} placeholder="Full Name *" className={inputClass} />
              <div className="mt-4 grid grid-cols-[110px_1fr] gap-3">
                <select className={inputClass}>{dialCodes.map((d) => <option key={d} className="bg-[#0a1228]">{d}</option>)}</select>
              ...
              <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="Business Email *" className={`${inputClass} mt-4`} />
              <textarea rows="3" name="message" value={form.message} onChange={handleChange} placeholder="Project Description *" className={`${inputClass} mt-4 resize-none`} />
